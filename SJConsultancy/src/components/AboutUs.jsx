  ...
  return (
    <section className="bg-lightGray py-12 px-4 md:px-12 min-h-screen">
      <div className="max-w-6xl mx-auto text-center">
        {/* Section Title */}
        <h1 className="text-4xl font-bold text-navyBlue mb-6">About Us</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold text-navyBlue mb-4">Our Vision</h2>
          ...
          {/* Mission Section */}
          <div className="bg-white p-8 rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold text-navyBlue mb-4">Our Mission</h2>
            <p className="text-lg text-gray-700">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-navyBlue mb-6">Our Core Values</h2>
        ...
        {/* Team Section */}
        <h2 className="text-3xl font-bold text-navyBlue mb-6">Meet Our Team</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow-md">
              ...
              />
              <h3 className="text-2xl font-semibold text-navyBlue mb-2">{member.name}</h3>
        ...
        <div className="bg-deepGreen text-white py-6 px-4 rounded-lg mt-12">
